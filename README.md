...
[![Latest Release](https://img.shields.io/github/v/release/xenstar/salaah-time-v4-releases?style=flat-square&label=Latest%20Version&color=C79A36)](https://github.com/xenstar/salaah-time-v4-releases/releases/latest)
![Windows 10 and 11](https://img.shields.io/badge/Windows-10%20%7C%2011-0078D4?style=flat-square&logo=windows11&logoColor=white)
...
- Flash the window or tray icon
- Fullscreen prayer reminder
- Always-on-top mode

### 🗓️ Complete prayer timetable

- Accurate prayer times based on your location
- Fajr, Sunrise, Dhuhr, Asr, Maghrib, and Isha
- Current prayer and next prayer countdown
- Daily, monthly, and yearly views
- View prayer times for another date
- Multiple calculation methods
- Shafi and Hanafi Asr options
- High-latitude support
- Tahajjud and Ishraq/Duha times
- Clear guidance for forbidden prayer times

### 🌙 Ramadan companion

- Automatically recognizes Ramadan
- Suhur ending time and Iftar time
- Live Ramadan countdowns
- Hijri date with adjustable date correction
- Islamic calendar and important events

### 🧭 Qibla, Duas, and daily inspiration

- Qibla direction and distance from your location
- Offline collection of Duas
- Dua categories, search, and repetition counter
- Daily Quran verse, Hadith, Dua, and Name of Allah
- Hide any section you do not want to see

### 🖥️ Made for your desktop

- Floating next-prayer countdown widget
- Runs quietly in the system tray
- Optional start with Windows
- Start minimized or minimize to tray
- Light and dark themes
- Compact and full layouts
- Remembers your window position
...
[![Download Latest Version](https://img.shields.io/badge/⬇_DOWNLOAD_LATEST_VERSION-Windows_10_&_11-0F766E?style=for-the-badge)](https://github.com/xenstar/salaah-time-v4-releases/releases/latest)

**Available now for Windows 10 and Windows 11**

</div>

### Installation

1. Open the [latest release](https://github.com/xenstar/salaah-time-v4-releases/releases/latest).
...
Yes. Essential prayer calculations and bundled Islamic content work offline. Internet access is mainly used to check for new versions.

</details>

<details>
<summary><strong>Can I change the calculation method?</strong></summary>

Yes. You can select the calculation method, Asr madhab, high-latitude rule, location, and time format.
